...
public class Game extends JPanel implements ActionListener{
    ...
    ArrayList<peluruMusuh> bulletB = new ArrayList<>();
...
//                    barrierDesign();
                    ...
                    for (boss i : bos) {
                        if (i.getJenisbos() == 1) {
                            ...
                            this.remove(i.getSprite());
                            i.setSprite(new JLabel(new ImageIcon("res/foto/boss8.png")));
                            i.getSprite().setSize(100, 100);
                            i.getSprite().setLocation(i.getXbos(), i.getYbos());
                            this.add(i.getSprite());
                            i.setDelaybos(i.getDelaybos() + 1);
                    ...
                    // tembak player 1-> space 2-> missile
                    if (TEMBAK == 1) {
                    ...
                    if (Start == 0) {
                        for (peluru i : bullet) {
                            ...
                            for (boss j : bos) {
                                if (j.getXbos() <= i.getPelurux() && j.getXbos() + 60 >= i.getPelurux() && j.getYbos() - 50 <= i.getPeluruy() && j.getYbos() + 20 >= i.getPeluruy()) {
                                    score += 100;
                                    this.remove(j.getSprite());
                                    bos.remove(j);
                                    menang = true;
    ...
    public void bosShoot(){
        for (boss i : bos) {
            ...
            if (randomizer == 1 || randomizer == 2 || randomizer == 3) {
                tembakanbot = 1;
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() - 35, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() - 15, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() + 5, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() - 55, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() + 25, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() + 45, 1));
                bulletB.add(new peluruMusuh(i.getXbos() - 50, i.getYbos() - 75, 1));

            }
        }
        for (peluruMusuh i : bulletB) {
            if (i.getPeluruaktif() == 1) {
                i.setPelurux(i.getPelurux() - 15);
                i.setSprite(new JLabel(new ImageIcon("res/foto/lasergreen.png")));
                i.getSprite().setSize(100, 100);
